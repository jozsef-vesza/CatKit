...
SWIFT_CLASS("_TtC13CatKitExample11AppDelegate")
...
SWIFT_CLASS("_TtC13CatKitExample14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * __null_unspecified catImageView;
